...
describe('GET /users', () => {
  ...
  describe('Casos de falha', () => {
    ...
    describe('Quando não existe nenhuma usuário cadastrado', () => {
      let response;
      ...
      it(`a propriedade "data" possui o texto "${NO_REGISTRED_USERS}"`, () => {
        expect(response.body.data).to.be.equal(NO_REGISTRED_USERS);
      });
    });
  });
